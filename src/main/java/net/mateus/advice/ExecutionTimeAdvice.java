...
public class ExecutionTimeAdvice {
  ...
  @Around("@annotation(net.mateus.advice.TrackExecutionTime)")
  public Object executionTime(ProceedingJoinPoint point) throws Throwable {
    return logExecutionTime(point);
  }

  // Log execution time of BAC methods
  @Around("execution(*  net.mateus.domain.employee.BAC.*.*(..))")
  ...
  @Around("execution(* net.mateus.domain.employee.BAR.*.*(..))")
